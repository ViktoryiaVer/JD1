...
public class OperatorsPriority {
    public static void main(String[] args) {
        ...
        // в тернарном операторе используется булевый и целочисленный тип данных, а результат присваивается int, кроме
        // того существует вероятность того, что булевый оператор придется делить на число

...
public class SearchEngineCaseInsensitiveTest {
    private final ISearchEngine searchEngine = new SearchEngineCaseInsensitive(new SearchEnginePunctuationNormalizer(new EasySearch()));
    ...
    public void searchTwoWordsWordsInSong() {
        ...
        Assertions.assertEquals(25,searchEngine.search(text,word1));
        Assertions.assertEquals(25,searchEngine.search(text,word2));
        Assertions.assertEquals(25,searchEngine.search(text,word3));
    ...
    public void searchSeveralSimilarWords() {
        ...
        Assertions.assertEquals(2,searchEngine.search(text,word1));
        Assertions.assertEquals(2,searchEngine.search(text,word2));
    }
